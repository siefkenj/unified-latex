...
\begin{tikzpicture}
  ...
  \shade (2,0) rectangle +(1,1);
    ...
    \draw foreach \position in {(0,0), (1,1), (2,0), (3,1), (1,1), (2,0), (3,1)}
    { \position rectangle +(.25,.5) \position -- +(.25,.5)};
    
    \draw node at (1,0) (A) [fill=blue] [red] {a a a a a a a};

    \draw node :path = {
                            0s = "{(0,-1) .. controls (0,0) and (0,0)   .. (0,1) -- (1,1)}",
                            2s = "{(0,-1) .. controls (-1,0) and (-1,0) .. (-1,1) -- (.5,-1)}",
                            begin on=click }
                      [fill = blue!20, draw = blue, ultra thick, circle] {Click me!a a a a a a a a a a a a a a};
    \draw node %comment1
     at (1,0) %comment2
     %comment2.5
      (A) [fill=blue] %comment3
       [red] {a a a a a a a};
